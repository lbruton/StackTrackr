...
- Version is defined once in `js/constants.js` as `APP_VERSION = '3.04.03'`
...
- `js/constants.js` provides:
  - `getVersionString(prefix)`: Returns formatted version (e.g., "v3.04.03")
...
1. **Update ONLY the constants file:**
   ```javascript
   // In js/constants.js
    const APP_VERSION = '3.04.03';  // Change this line only
   ```

2. **All these will automatically update:**
  - Page title: "StackTrackr v3.04.03"
  - Page heading: "StackTrackr v3.04.03"
  - Browser tab title: "StackTrackr v3.04.03"
