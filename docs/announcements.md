...
- **Clone Picker Modal (v3.33.16)**: Select/deselect fields when cloning items, edit variant values inline, batch-clone date/mint variants via Save & Clone Another with live counter
