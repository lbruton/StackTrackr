...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.32.08 &ndash; WeakMap Search Cache Correctness</strong>: Fixed cache miss guard to use strict undefined check instead of falsy. Notes edits now invalidate the search cache immediately. Removed redundant O(N) scan in Numista tag batch apply</li>
