...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.32.35 &ndash; Header Buttons Drag-to-Sort</strong>: Drag header button cards in Settings &rarr; Appearance to reorder them. Order persists across sessions (STAK-320).</li>
