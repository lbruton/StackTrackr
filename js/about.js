...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.30.05 &ndash; Goldback Sorting Fix</strong>: Sorting by Melt, Retail, Gain/Loss, and Weight columns now correctly handles Goldback items. Previously a &frac12; Goldback was computed as 0.5 ozt instead of 0.0005 ozt, inflating sort values ~1000x. Retail and Gain/Loss sorting now uses denomination pricing</li>
